...
char menubuffer[20];
extern unsigned char titelbuffer[20];
...
void display_go_to (uint8_t, uint8_t);
...
void r_uitoa8(int8_t zahl, uint8_t string);
...
volatile uint8_t char_x;
	volatile uint8_t char_y;
	volatile uint8_t char_height_mul;
	volatile uint8_t char_width_mul;
